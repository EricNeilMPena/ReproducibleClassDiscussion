...
for(i in 1:nrow(GMADataset)){
      GMADataset[i,16] = distm(c(GMADataset[i, 12], GMADataset[i,11]), c(121.0499,  14.5535), fun = distHaversine) / 1000
}
...
Create a mapping plot of the top 100 barangays with the provinces to visualize
